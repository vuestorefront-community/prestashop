          ...
          <div class="collected-product-list">
            <transition-group name="fade" tag="div">
              <SfCollectedProduct
                ...
                :image="addBasePath(product.default_image.url)"
                :title="product.name"
                :regular-price="$n(product.price_without_reduction, 'currency')"
                :special-price="$n(product.price_without_reduction, 'currency') === product.price? '':product.price"
                :stock="99999"
                image-width="180"
                image-height="200"
